...
const IdentityImageField = ({ image, title, inputClass, labelClass }: IdentityImageFieldProps) => {
  ...
  return (
    <>
      <div className="relative aspect-[13/14] overflow-hidden border border-shadow-black/10 bg-main-white">
        {previewUrl ? (
          <Image src={previewUrl} alt={title} fill sizes="280px" className="object-cover" />
        ) : (
...
export default IdentityImageField;
